...
Not implemented yet: `POST /search` returns 501 naming the stage that builds it,
...
from octollm_common.models.contracts import SearchRequest, SearchResponse
from octollm_common.roster import spec_for

SPEC = spec_for("retriever")

app = create_arm_app(SPEC, request_model=SearchRequest, response_model=SearchResponse)
