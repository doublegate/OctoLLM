...
Not implemented yet: `POST /code` returns 501 naming the stage that builds it,
...
from octollm_common.models.contracts import CodeRequest, CodeResponse
from octollm_common.roster import spec_for

SPEC = spec_for("coder")

app = create_arm_app(SPEC, request_model=CodeRequest, response_model=CodeResponse)
